    ...
    <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">
                Daftar berita yang telah dihapus sementara
            </p>
        </div>
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4">
                                ...
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    {{-- RESTORE --}}
                                    <form
                                        action="{{ url('admin/berita/restore/' . $item->berita_id) }}"
                                        method="POST"
                                    >
                                        @csrf
                                    ...
                                    {{-- DELETE PERMANENT --}}
                                    <form
                                        action="{{ url('admin/berita/force-delete/' . $item->berita_id) }}"
                                        method="POST"
                                        onsubmit="return confirm('Hapus permanen berita ini?')"
                                    >
                                        @csrf
                                        @method('DELETE')
